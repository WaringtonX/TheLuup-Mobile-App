...
{
    class AdvertAdapter : RecyclerView.Adapter
    {
        private List<LuppAdvertisemnet> mAdvertisemnets;
        private Context mContext;
        private Service1 client1 = new Service1();

        public AdvertAdapter(Context Context, List<LuppAdvertisemnet> advertisemnets)
        {
        ...
        public void updateViewsNorm(List<LuppAdvertisemnet> advertise)
        {
            // updateRequest();
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            View itemView = LayoutInflater.From(parent.Context).
                   Inflate(Resource.Layout.layout_advert_listitem, parent, false);
        ...
        public class AdvertAdapterViewHolder : RecyclerView.ViewHolder
        {
            ...
            public AdvertAdapterViewHolder(View itemView) : base(itemView)
            {
                ...
                adimage = itemView.FindViewById<CircleImageView> (Resource.Id.adresimage);
                adrest = itemView.FindViewById<ImageView>(Resource.Id.adcertImageview);
                adressname = itemView.FindViewById<TextView>(Resource.Id.adresname);
                addresemail = itemView.FindViewById<TextView>(Resource.Id.adresstatus);
                addrestittle = itemView.FindViewById<TextView>(Resource.Id.adtittle);
                addresSlogan = itemView.FindViewById<TextView>(Resource.Id.adslogan);
                addresprice = itemView.FindViewById<TextView>(Resource.Id.addprice);
            }
        }
    }
