...
namespace TheLuupApp.SlidingTab
{
    class SlidingTabScrollView : HorizontalScrollView
    {
        ...
        public SlidingTabScrollView(Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
        {
            ...
            FillViewport = true;
            this.SetBackgroundColor(Android.Graphics.Color.ParseColor("#ff7a14")); //Gray color  
        ...
        private void PopulateTabStrip()
        {
            ...
            for (int i = 0; i < adapter.Count; i++)
            {
                ...
                tabView.Text = ((PageTabsAdapter)adapter).GetPageTitle(i);
                tabView.SetTextColor(Android.Graphics.Color.White);
                tabView.SetAllCaps(false);
                tabView.Tag = i;
